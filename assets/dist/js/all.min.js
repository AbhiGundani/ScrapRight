...
function showPassword(){var e=document.getElementById("myInput");"password"===e.type?e.type="text":e.type="password"}function showContent(){var e=document.getElementById("myBox");"none"===e.style.display?e.style.display="block":e.style.display="none"}$("#file-upload").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$("#filename").text(e)})),$(document).ready((function(){$(".add-after").after('<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16.0627 7.33363C16.3574 7.00445 16.3295 6.49869 16.0003 6.20398C15.6711 5.90927 15.1653 5.93721 14.8706 6.26639L11.2769 10.2804C10.5486 11.0938 10.0582 11.6387 9.63895 11.9911C9.23954 12.3268 9.00494 12.4 8.8 12.4C8.59507 12.4 8.36047 12.3268 7.96105 11.9911C7.54176 11.6387 7.05136 11.0938 6.32315 10.2804L5.39603 9.2449C5.10132 8.91573 4.59556 8.88779 4.26638 9.1825C3.93721 9.47721 3.90927 9.98297 4.20398 10.3121L5.17073 11.3919C5.84896 12.1495 6.41467 12.7815 6.93158 13.2159C7.47839 13.6755 8.06819 14 8.8 14C9.53181 14 10.1216 13.6755 10.6684 13.2159C11.1853 12.7815 11.751 12.1496 12.4293 11.392L16.0627 7.33363Z" fill="white"/></svg>'),$(".add-after2").after('<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="10" height="10" rx="5" transform="matrix(1 0 0 -1 5 15)" fill="#3384D8"/></svg>');const e=[].slice.call(document.querySelectorAll(".nav-expand"));e.forEach((e=>{e.querySelector(".nav-expand-content").insertAdjacentHTML("afterbegin",'<li class="nav-item">\n      <a class="nav-link nav-back-link" href="javascript:;">\n      <span class="material-symbols-rounded">chevron_left</span>\n        Back\n      </a>\n    </li>'),e.querySelector(".nav-link").addEventListener("click",(()=>e.classList.add("active"))),e.querySelector(".nav-back-link").addEventListener("click",(()=>e.classList.remove("active")))})),$(".selectpicker").selectpicker()}));const holidays=[],calendar=document.querySelector("#calendar"),monthBanner=document.querySelector("#month");let navigation=0,clicked=null,events=localStorage.getItem("events")?JSON.parse(localStorage.getItem("events")):[];const weekdays=["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"];function loadCalendar(){const e=new Date;0!=navigation&&e.setMonth((new Date).getMonth()+navigation);const t=e.getDate(),n=e.getMonth(),a=e.getFullYear();monthBanner.innerText=`${e.toLocaleDateString("en-us",{month:"long"})} ${a}`,calendar.innerHTML="";const l=new Date(a,n+1,0).getDate(),o=new Date(a,n,1).toLocaleDateString("en-us",{weekday:"long",year:"numeric",month:"numeric",day:"numeric"}).split(", ")[0],d=weekdays.indexOf(o);for(let e=1;e<=l+d;e++){const l=document.createElement("div");l.classList.add("day");const o=`${e-d<10?"0"+(e-d):e-d}-${n+1<10?"0"+(n+1):n+1}-${a}`;if(e>d){l.innerText=e-d;const n=events.find((e=>e.date==o)),a=holidays.find((e=>e.hdate==o));if(e-d===t&&0==navigation&&(l.id="currentDay"),n){const e=document.createElement("div");e.classList.add("event"),e.innerText=n.title,l.appendChild(e)}if(a){const e=document.createElement("div");e.classList.add("event"),e.classList.add("holiday"),e.innerText=a.holiday,l.appendChild(e)}l.addEventListener("click",(()=>{showModal(o)}))}else l.classList.add("plain");calendar.append(l)}}function buttons(){const e=document.querySelector("#btnBack"),t=document.querySelector("#btnNext"),n=document.querySelector("#btnDelete"),a=document.querySelector("#btnSave"),l=document.querySelectorAll(".btnClose"),o=document.querySelector("#txtTitle");e.addEventListener("click",(()=>{navigation--,loadCalendar()})),t.addEventListener("click",(()=>{navigation++,loadCalendar()})),modal.addEventListener("click",closeModal),l.forEach((e=>{e.addEventListener("click",closeModal)})),n.addEventListener("click",(function(){events=events.filter((e=>e.date!==clicked)),localStorage.setItem("events",JSON.stringify(events)),closeModal()})),a.addEventListener("click",(function(){o.value?(o.classList.remove("error"),events.push({date:clicked,title:o.value.trim()}),o.value="",localStorage.setItem("events",JSON.stringify(events)),closeModal()):o.classList.add("error")}))}const modal=document.querySelector("#modal"),viewEventForm=document.querySelector("#viewEvent"),addEventForm=document.querySelector("#addEvent");function showModal(e){clicked=e;const t=events.find((t=>t.date==e));t?(document.querySelector("#eventText").innerText=t.title,viewEventForm.style.display="block"):addEventForm.style.display="block",modal.style.display="block"}function closeModal(){viewEventForm.style.display="none",addEventForm.style.display="none",modal.style.display="none",clicked=null,loadCalendar()}buttons(),loadCalendar();